...
def test_strideb0_pack_nn(tmpdir):
 Tensile.Tensile([Tensile.TensileTestPath("nightly/pack_tensor_dims/strideb0_pack_nn.yaml"), tmpdir.strpath])
...
def test_stridea0_pack_nt(tmpdir):
 Tensile.Tensile([Tensile.TensileTestPath("nightly/pack_tensor_dims/stridea0_pack_nt.yaml"), tmpdir.strpath])
