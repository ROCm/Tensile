...
def test_persistent(tmpdir):
    Tensile.Tensile([Tensile.TensileConfigPath("nightly/classic/test_persistent.yaml"), tmpdir.strpath])

# tensor convolution
def test_convolution(tmpdir):
    Tensile.Tensile([Tensile.TensileConfigPath("nightly/classic/test_convolution.yaml"), tmpdir.strpath])

# tensor contractions
def test_tensor_contraction(tmpdir):
    Tensile.Tensile([Tensile.TensileConfigPath("nightly/classic/test_tensor_contraction.yaml"), tmpdir.strpath])
