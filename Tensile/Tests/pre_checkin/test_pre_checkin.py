...
def test_sgemm_asm_tn_bigk(tmpdir):
 Tensile.Tensile([Tensile.TensileTestPath("pre_checkin/sgemm_asm_tn_bigk.yaml"), tmpdir.strpath])
...
def test_persistent_asm(tmpdir):
 Tensile.Tensile([Tensile.TensileTestPath("pre_checkin/test_persistent_asm.yaml"), tmpdir.strpath])
